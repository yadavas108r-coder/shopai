  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="card w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4">Login to ShopAI</h2>
        ...
        <div className="mt-3 text-sm text-gray-600">No account? <Link to="/signup" className="text-primary">Create account</Link></div>
      </div>
    </div>
  );
}
